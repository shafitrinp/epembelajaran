    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <button type="button" class="btn btn-md btn-primary" id="jtopik" data-toggle="modal" data-target="#Modaltambahjudul">Tambah Tugas</button>

                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0" href="<?php echo base_url('C_guru/tampil_jtopik'); ?>" method="post" style="width:100%">
                                    ...
                                    <div class="modal fade" id="Modaltambahjudul" role="dialog">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form class="form-horizontal" method="post" action="<?php echo base_url() . 'C_guru/jtugas' ?>">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="id_kelas" required>
                                                                <option <?php if ($id_kelas != null) {
                                                                                echo "selected";
                                                                            } ?> value="<?php echo $id_kelas; ?>"><?php echo $id_kelas ?></option>
